...
type (
	pmsSkuStockModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsSkuStockModel) (*PmsSkuStockPagination, error)
...
func (m *defaultPmsSkuStockModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsSkuStockModel) (*PmsSkuStockPagination, error) {
	page := keyword.Page
