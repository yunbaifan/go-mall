...
type (
	umsRoleMenuRelationModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*UmsRoleMenuRelationPagination, error)
...
func (m *defaultUmsRoleMenuRelationModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*UmsRoleMenuRelationPagination, error) {
	// 总行数
