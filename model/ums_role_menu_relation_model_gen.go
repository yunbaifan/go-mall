...
type (
	umsRoleMenuRelationModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsRoleMenuRelationModel) (*UmsRoleMenuRelationPagination, error)
...
func (m *defaultUmsRoleMenuRelationModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsRoleMenuRelationModel) (*UmsRoleMenuRelationPagination, error) {
	page := keyword.Page
