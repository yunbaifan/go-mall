...
type (
	smsHomeRecommendProductModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordSmsHomeRecommendProductModel) (*SmsHomeRecommendProductPagination, error)
...
func (m *defaultSmsHomeRecommendProductModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordSmsHomeRecommendProductModel) (*SmsHomeRecommendProductPagination, error) {
	page := keyword.Page
