...
type (
	smsHomeRecommendProductModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*SmsHomeRecommendProductPagination, error)
...
func (m *defaultSmsHomeRecommendProductModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*SmsHomeRecommendProductPagination, error) {
	// 总行数
