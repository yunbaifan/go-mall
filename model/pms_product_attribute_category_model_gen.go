...
type (
	pmsProductAttributeCategoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordPmsProductAttributeCategoryModel) (*PmsProductAttributeCategoryPagination, error)
...
func (m *defaultPmsProductAttributeCategoryModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordPmsProductAttributeCategoryModel) (*PmsProductAttributeCategoryPagination, error) {
	page := keyword.Page
