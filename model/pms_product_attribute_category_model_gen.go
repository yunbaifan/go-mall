...
type (
	pmsProductAttributeCategoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*PmsProductAttributeCategoryPagination, error)
...
func (m *defaultPmsProductAttributeCategoryModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*PmsProductAttributeCategoryPagination, error) {
	// 总行数
