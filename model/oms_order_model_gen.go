...
type (
	omsOrderModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordOmsOrderModel) (*OmsOrderPagination, error)
...
func (m *defaultOmsOrderModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordOmsOrderModel) (*OmsOrderPagination, error) {
	page := keyword.Page
