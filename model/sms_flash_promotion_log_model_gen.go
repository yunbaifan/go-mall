...
type (
	smsFlashPromotionLogModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordSmsFlashPromotionLogModel) (*SmsFlashPromotionLogPagination, error)
	...
	KeywordSmsFlashPromotionLogModel struct {
...
func (m *defaultSmsFlashPromotionLogModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordSmsFlashPromotionLogModel) (*SmsFlashPromotionLogPagination, error) {
	page := keyword.Page
