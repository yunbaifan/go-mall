...
type (
	smsHomeRecommendSubjectModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordSmsHomeRecommendSubjectModel) (*SmsHomeRecommendSubjectPagination, error)
...
func (m *defaultSmsHomeRecommendSubjectModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordSmsHomeRecommendSubjectModel) (*SmsHomeRecommendSubjectPagination, error) {
	page := keyword.Page
