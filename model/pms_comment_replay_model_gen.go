...
type (
	pmsCommentReplayModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsCommentReplayModel) (*PmsCommentReplayPagination, error)
...
func (m *defaultPmsCommentReplayModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsCommentReplayModel) (*PmsCommentReplayPagination, error) {
	page := keyword.Page
