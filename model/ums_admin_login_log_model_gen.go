...
type (
	umsAdminLoginLogModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsAdminLoginLogModel) (*UmsAdminLoginLogPagination, error)
...
func (m *defaultUmsAdminLoginLogModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsAdminLoginLogModel) (*UmsAdminLoginLogPagination, error) {
	page := keyword.Page
