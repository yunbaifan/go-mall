...
type (
	pmsAlbumPicModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsAlbumPicModel) (*PmsAlbumPicPagination, error)
...
func (m *defaultPmsAlbumPicModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsAlbumPicModel) (*PmsAlbumPicPagination, error) {
	page := keyword.Page
