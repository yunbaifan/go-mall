...
type (
	umsRolePermissionRelationModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsRolePermissionRelationModel) (*UmsRolePermissionRelationPagination, error)
...
func (m *defaultUmsRolePermissionRelationModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsRolePermissionRelationModel) (*UmsRolePermissionRelationPagination, error) {
	page := keyword.Page
