...
type (
	pmsFeightTemplateModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*PmsFeightTemplatePagination, error)
...
func (m *defaultPmsFeightTemplateModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*PmsFeightTemplatePagination, error) {
	// 总行数
