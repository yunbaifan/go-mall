...
type (
	smsFlashPromotionModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*SmsFlashPromotionPagination, error)
...
func (m *defaultSmsFlashPromotionModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*SmsFlashPromotionPagination, error) {
	// 总行数
