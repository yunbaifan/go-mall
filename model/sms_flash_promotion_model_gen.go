...
type (
	smsFlashPromotionModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordSmsFlashPromotionModel) (*SmsFlashPromotionPagination, error)
...
func (m *defaultSmsFlashPromotionModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordSmsFlashPromotionModel) (*SmsFlashPromotionPagination, error) {
	page := keyword.Page
