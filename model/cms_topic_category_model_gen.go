...
type (
	cmsTopicCategoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordCmsTopicCategoryModel) (*CmsTopicCategoryPagination, error)
...
func (m *defaultCmsTopicCategoryModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordCmsTopicCategoryModel) (*CmsTopicCategoryPagination, error) {
	page := keyword.Page
