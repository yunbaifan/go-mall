...
type (
	cmsTopicCategoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*CmsTopicCategoryPagination, error)
...
func (m *defaultCmsTopicCategoryModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*CmsTopicCategoryPagination, error) {
	// 总行数
