...
type (
	cmsSubjectCategoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*CmsSubjectCategoryPagination, error)
...
func (m *defaultCmsSubjectCategoryModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*CmsSubjectCategoryPagination, error) {
	// 总行数
