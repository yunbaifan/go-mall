...
type (
	pmsProductModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsProductModel) (*PmsProductPagination, error)
...
func (m *defaultPmsProductModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsProductModel) (*PmsProductPagination, error) {
	page := keyword.Page
