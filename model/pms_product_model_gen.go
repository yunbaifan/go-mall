...
type (
	pmsProductModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordPmsProductModel) (*PmsProductPagination, error)
...
func (m *defaultPmsProductModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordPmsProductModel) (*PmsProductPagination, error) {
	page := keyword.Page
