...
type (
	umsIntegrationConsumeSettingModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*UmsIntegrationConsumeSettingPagination, error)
...
func (m *defaultUmsIntegrationConsumeSettingModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*UmsIntegrationConsumeSettingPagination, error) {
	// 总行数
