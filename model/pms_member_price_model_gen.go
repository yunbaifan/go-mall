...
type (
	pmsMemberPriceModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsMemberPriceModel) (*PmsMemberPricePagination, error)
...
func (m *defaultPmsMemberPriceModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsMemberPriceModel) (*PmsMemberPricePagination, error) {
	page := keyword.Page
