...
type (
	umsGrowthChangeHistoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*UmsGrowthChangeHistoryPagination, error)
...
func (m *defaultUmsGrowthChangeHistoryModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*UmsGrowthChangeHistoryPagination, error) {
	// 总行数
