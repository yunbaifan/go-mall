...
type (
	umsGrowthChangeHistoryModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsGrowthChangeHistoryModel) (*UmsGrowthChangeHistoryPagination, error)
...
func (m *defaultUmsGrowthChangeHistoryModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsGrowthChangeHistoryModel) (*UmsGrowthChangeHistoryPagination, error) {
	page := keyword.Page
