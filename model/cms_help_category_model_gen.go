...
type (
	cmsHelpCategoryModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordCmsHelpCategoryModel) (*CmsHelpCategoryPagination, error)
...
func (m *defaultCmsHelpCategoryModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordCmsHelpCategoryModel) (*CmsHelpCategoryPagination, error) {
	page := keyword.Page
