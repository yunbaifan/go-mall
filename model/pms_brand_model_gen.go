...
type (
	pmsBrandModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*PmsBrandPagination, error)
...
func (m *defaultPmsBrandModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*PmsBrandPagination, error) {
	// 总行数
