...
type (
	umsRoleModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*UmsRolePagination, error)
...
func (m *defaultUmsRoleModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*UmsRolePagination, error) {
	// 总行数
