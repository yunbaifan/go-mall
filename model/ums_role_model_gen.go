...
type (
	umsRoleModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsRoleModel) (*UmsRolePagination, error)
...
func (m *defaultUmsRoleModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsRoleModel) (*UmsRolePagination, error) {
	page := keyword.Page
