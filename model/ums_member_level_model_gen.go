...
type (
	umsMemberLevelModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsMemberLevelModel) (*UmsMemberLevelPagination, error)
...
func (m *defaultUmsMemberLevelModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsMemberLevelModel) (*UmsMemberLevelPagination, error) {
	page := keyword.Page
