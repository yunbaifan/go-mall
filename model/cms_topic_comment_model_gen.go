...
type (
	cmsTopicCommentModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*CmsTopicCommentPagination, error)
...
func (m *defaultCmsTopicCommentModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*CmsTopicCommentPagination, error) {
	// 总行数
