...
type (
	omsCompanyAddressModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordOmsCompanyAddressModel) (*OmsCompanyAddressPagination, error)
...
func (m *defaultOmsCompanyAddressModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordOmsCompanyAddressModel) (*OmsCompanyAddressPagination, error) {
	page := keyword.Page
