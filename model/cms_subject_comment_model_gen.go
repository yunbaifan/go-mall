...
type (
	cmsSubjectCommentModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*CmsSubjectCommentPagination, error)
...
func (m *defaultCmsSubjectCommentModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*CmsSubjectCommentPagination, error) {
	// 总行数
