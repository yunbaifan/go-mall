...
type (
	pmsProductCategoryModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsProductCategoryModel) (*PmsProductCategoryPagination, error)
	...
	KeywordPmsProductCategoryModel struct {
...
func (m *defaultPmsProductCategoryModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordPmsProductCategoryModel) (*PmsProductCategoryPagination, error) {
	page := keyword.Page
