...
type (
	pmsProductCategoryModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordPmsProductCategoryModel) (*PmsProductCategoryPagination, error)
...
func (m *defaultPmsProductCategoryModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordPmsProductCategoryModel) (*PmsProductCategoryPagination, error) {
	page := keyword.Page
