...
type (
	omsOrderReturnApplyModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*OmsOrderReturnApplyPagination, error)
...
func (m *defaultOmsOrderReturnApplyModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*OmsOrderReturnApplyPagination, error) {
	// 总行数
