...
type (
	umsMemberMemberTagRelationModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsMemberMemberTagRelationModel) (*UmsMemberMemberTagRelationPagination, error)
...
func (m *defaultUmsMemberMemberTagRelationModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsMemberMemberTagRelationModel) (*UmsMemberMemberTagRelationPagination, error) {
	page := keyword.Page
