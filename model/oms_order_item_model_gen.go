...
type (
	omsOrderItemModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*OmsOrderItemPagination, error)
...
func (m *defaultOmsOrderItemModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*OmsOrderItemPagination, error) {
	// 总行数
