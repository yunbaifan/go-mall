...
type (
	cmsHelpModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordCmsHelpModel) (*CmsHelpPagination, error)
...
func (m *defaultCmsHelpModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordCmsHelpModel) (*CmsHelpPagination, error) {
	page := keyword.Page
