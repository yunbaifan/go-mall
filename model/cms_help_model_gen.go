...
type (
	cmsHelpModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*CmsHelpPagination, error)
...
func (m *defaultCmsHelpModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*CmsHelpPagination, error) {
	// 总行数
