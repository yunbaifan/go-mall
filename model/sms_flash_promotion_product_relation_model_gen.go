...
type (
	smsFlashPromotionProductRelationModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*SmsFlashPromotionProductRelationPagination, error)
...
func (m *defaultSmsFlashPromotionProductRelationModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*SmsFlashPromotionProductRelationPagination, error) {
	// 总行数
