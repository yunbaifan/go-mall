...
type (
	smsFlashPromotionProductRelationModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, keyword *KeywordSmsFlashPromotionProductRelationModel) (*SmsFlashPromotionProductRelationPagination, error)
...
func (m *defaultSmsFlashPromotionProductRelationModel) FindPageListByBuilder(db *gorm.DB, keyword *KeywordSmsFlashPromotionProductRelationModel) (*SmsFlashPromotionProductRelationPagination, error) {
	page := keyword.Page
