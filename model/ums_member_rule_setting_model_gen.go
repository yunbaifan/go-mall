...
type (
	umsMemberRuleSettingModel interface {
		...
		FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsMemberRuleSettingModel) (*UmsMemberRuleSettingPagination, error)
...
func (m *defaultUmsMemberRuleSettingModel) FindPageListByBuilder(ctx context.Context, keyword *KeywordUmsMemberRuleSettingModel) (*UmsMemberRuleSettingPagination, error) {
	page := keyword.Page
