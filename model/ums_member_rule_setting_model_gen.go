...
type (
	umsMemberRuleSettingModel interface {
		...
		FindPageListByBuilder(ormSession *gorm.DB, page, pageSize int64) (*UmsMemberRuleSettingPagination, error)
...
func (m *defaultUmsMemberRuleSettingModel) FindPageListByBuilder(db *gorm.DB, page, pageSize int64) (*UmsMemberRuleSettingPagination, error) {
	// 总行数
