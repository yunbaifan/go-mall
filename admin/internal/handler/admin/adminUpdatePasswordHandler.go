...
func AdminUpdatePasswordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := admin.NewAdminUpdatePasswordLogic(r.Context(), svcCtx)
		resp, err := l.AdminUpdatePassword(&req)
